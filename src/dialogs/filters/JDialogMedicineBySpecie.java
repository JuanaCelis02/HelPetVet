...
public class JDialogMedicineBySpecie extends JDialog {
    ...
    public JDialogMedicineBySpecie(Presenter presenter) {
    ...
    private void initComponents() {
        ...
        category = new JComboBox<>(Specie.values());
        ...
        buttonSelectCategory = new view.RoundedJButton(15, 15, HandlerLanguage.languageProperties.getProperty( ConstantGUI.T_JD_SELECT_CATEGORY), Color.decode("#337AB7"), Color.WHITE, EVENTS.C_SHOW_TABLE_MEDICINE_BY_SPECIE.toString(), myPresenter);
        jPanelDialogContainer.add(buttonSelectCategory);

        add(jPanelDialogContainer, BorderLayout.CENTER);
    }

    public Specie getSelectCategory(){
        setVisible(false);
        return (Specie) category.getSelectedItem();
    }
}
