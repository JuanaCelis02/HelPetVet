...
public class JDialogDoctorsByCategory extends JDialog {
    ...
    public JDialogDoctorsByCategory(Presenter presenter) {
    ...
    private void initComponents() {
        ...
        buttonSelectCategory = new view.RoundedJButton(15, 15, HandlerLanguage.languageProperties.getProperty( ConstantGUI.T_JD_SELECT_CATEGORY), Color.decode("#337AB7"), Color.WHITE, EVENTS.C_SHOW_TABLE_DOCTORS_BY_CATEGORY.toString(), myPresenter);
